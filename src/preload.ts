...
contextBridge.exposeInMainWorld("electron", {
  ...
  bookmarks: {
    ...
    delete: (bookmarkId: string) =>
      ipcRenderer.invoke("bookmarks:delete", bookmarkId),
    update: (bookmarkId: string, updates: any) =>
      ipcRenderer.invoke("bookmarks:update", bookmarkId, updates),
    createFolder: (name: string) =>
      ipcRenderer.invoke("bookmarks:createFolder", name),
    getFolders: () => ipcRenderer.invoke("bookmarks:getFolders"),
    deleteFolder: (folderId: string) =>
      ipcRenderer.invoke("bookmarks:deleteFolder", folderId),
  ...
  history: {
    add: (title: string, url: string, favicon?: string) =>
      ipcRenderer.invoke("history:add", title, url, favicon),
    get: (limit?: number, search?: string) =>
      ipcRenderer.invoke("history:get", limit, search),
    ...
    clearSince: (since: number) =>
      ipcRenderer.invoke("history:clearSince", since),
    getTopVisited: (limit?: number) =>
  ...
  downloads: {
    ...
    delete: (downloadId: string) =>
      ipcRenderer.invoke("downloads:delete", downloadId),
    clear: () => ipcRenderer.invoke("downloads:clear"),
    getPath: () => ipcRenderer.invoke("downloads:getPath"),
    setPath: () => ipcRenderer.invoke("downloads:setPath"),
    getByDate: (days?: number) =>
      ipcRenderer.invoke("downloads:getByDate", days),
    getByMimeType: (mimeType: string) =>
      ipcRenderer.invoke("downloads:getByMimeType", mimeType),
    export: () => ipcRenderer.invoke("downloads:export"),
    import: (downloads: any) =>
      ipcRenderer.invoke("downloads:import", downloads),
    cancel: (downloadId: string) =>
      ipcRenderer.invoke("downloads:cancel", downloadId),
  ...
  settings: {
    getDefaultSearchEngine: () =>
      ipcRenderer.invoke("settings:getDefaultSearchEngine"),
    setDefaultSearchEngine: (engineId: string) =>
      ipcRenderer.invoke("settings:setDefaultSearchEngine", engineId),
    getSearchEngines: () => ipcRenderer.invoke("settings:getSearchEngines"),
    getSearchEngineById: (id: string) =>
      ipcRenderer.invoke("settings:getSearchEngineById", id),
    addCustomSearchEngine: (name: string, url: string, icon?: string) =>
      ipcRenderer.invoke("settings:addCustomSearchEngine", name, url, icon),
    deleteSearchEngine: (engineId: string) =>
      ipcRenderer.invoke("settings:deleteSearchEngine", engineId),
    getHomepage: () => ipcRenderer.invoke("settings:getHomepage"),
    setHomepage: (url: string) =>
      ipcRenderer.invoke("settings:setHomepage", url),
    ...
    setAIConfig: (config: any) =>
      ipcRenderer.invoke("settings:setAIConfig", config),
    getRestoreTabs: () => ipcRenderer.invoke("settings:getRestoreTabs"),
    setRestoreTabs: (enabled: boolean) =>
      ipcRenderer.invoke("settings:setRestoreTabs", enabled),
